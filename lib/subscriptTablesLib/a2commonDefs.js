...
// replace__WithDots = function(valueWith__AsDecimal){
// 	if(!valueWith__AsDecimal)return valueWith__AsDecimal;
// 	return valueWith__AsDecimal.replace(DECIMAL_POINT_REPLACE,".");
// };
