...
if(Meteor.isServer){
    ...
    Meteor.publish('tableChangedByUser',function(){
      return TableChangedByUserCollection.find();
    });
      ...
      meteorClientInsert : function(jsonJavaList){
        try{
         ...
         // var userid = getUserId(this);
          ...
          var action = "insert";
          var obj = {'_id':id};
          TableChangedByUserCollection.remove(obj);
          obj.action = action;
          TableChangedByUserCollection.insert(obj);
          return [];
