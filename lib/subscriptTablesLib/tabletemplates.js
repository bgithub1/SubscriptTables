...
MeteorValidator.prototype.getLevels = function(levelPathArray){
	// see if the server's gethoice method has the validation
		...
		if(columnNames && columnNames.length>0){
			for(var i = 0;i<columnNames.length;i++){
				...
				if(!colInputRegexChoice){
					var possChoices =  null;
					var newColumnInputChoiceInstance = new ColumnInputChoiceClass(columnName,null,possChoices,false,regexString);
