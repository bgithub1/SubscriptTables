...
// // get column names that might be embedded as a record in the collection for this
// //  table.  
// getColumnNamesEmbedded = function(masterTableClassInstance){
// 		if(!masterTableClassInstance){
// 			return [];
// 		}

// 		// collName is mongo collection name
// 		var collName = masterTableClassInstance.collectionName;
// 		if(!collName){
// 			collName = masterTableClassInstance[mongoId_fid];
// 		}
// 		// get table name
// 		var tn = masterTableClassInstance[mongoId_fid];

// 		// get json from mongo		
// 		var coll = collTable[collName];
// 		var findObj = {};
// 		findObj._id=columnNames_id;
// 		var columnNamesEmbedded =  coll.find(findObj).fetch();
// 		if(!columnNamesEmbedded || columnNamesEmbedded.length<1){
// 			return null;
// 		}
// 		var embeddedNames = columnNamesEmbedded[0]
// 		var retArr = [];
// 		var keys = Object.keys(embeddedNames);
// 		for(var i =0; i<keys.length;i++){
// 			var key = keys[i];
// 			if(key <= '  ')continue;
// 			retArr.push(embeddedNames[key]);
// 		}
// 		return retArr;
// }
